...
#include "decaycurve_view_plugin_global.h"

#include <phast_gui/interfaces/idataviewplugin.h>
#include <qobject.h>

class DECAYCURVE_VIEW_PLUGINSHARED_EXPORT decaycurve_view_plugin : public QObject,
                                                                 public IDataviewPlugin
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "decaycurve_view_plugin" )
    Q_INTERFACES(IDataviewPlugin)

public:
    decaycurve_view_plugin() {}
