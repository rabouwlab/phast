 ...
 */
/*****************************************************************************/
/* $Id: tdcbase.h,v 1.5 2018/08/21 13:14:55 trurl Exp $ */
...
/** Check for five channel feature
 *
 *  Checks if the five channel feature is available for the connected device.
 *  This feature is necessary to enable the five channel mode, see  @ref TDC_setFiveChannelMode .
 *  @return  If the feature is available (1) or not (0)
 */
TDC_API Bln32 TDC_CC TDC_checkFeatureFiveChan();
